...
from .pose_resnet import BasicBlock, Bottleneck
from core.cfgs import cfg
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, pretrained=True, global_mode=False):
        ...
        self.corr_layer = self._make_corr_layer(720,cfg.FINAL_CHANNEL)
    ...
    def forward(self, x):
        ...
        s_feat = torch.cat([y_list[-4], x1, x2, x3], 1)
        s_feat = self.corr_layer(s_feat)
