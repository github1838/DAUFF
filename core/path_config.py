...
HOME_PATH = '/home/wz/work_dir/data'
...
DATASET_FILES = [{
    ...
    # 'mpi-inf-3dhp': join(DATASET_NPZ_PATH, 'mpi_inf_3dhp_valid.npz'),
    '3dpw': join(DATASET_NPZ_PATH, '3dpw_test.npz'),
    '3dpw_sub':join(DATASET_NPZ_PATH, '3dpw_test_sub.npz'),
    'coco': join(DATASET_NPZ_PATH, 'coco_2014_val.npz'),
    'dp_coco': join(DATASET_NPZ_PATH, 'dp_coco_2014_minival.npz'),
    'surreal': join(DATASET_NPZ_PATH, 'surreal_val.npz'),
    '3doh50k': join(DATASET_NPZ_PATH, 'threeDOH50K_testset.npz'),
...
PASCAL_ROOT = '/home/wz/work_dir/data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/'
PASCAL_OCCLUDERS_FILE = '/home/wz/work_dir/PyMAFtest/data/occlusion_augmentation/pascal_occluders.pkl'
COCO_OCCLUDERS_FILE = '/home/wz/work_dir/PyMAFtest/data/occlusion_augmentation/coco_occluders.pkl'
SMPL_MARKER = 'data/smpl_ssm.npy'
