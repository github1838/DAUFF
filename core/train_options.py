...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument('--depth_bins', type=int, default=41, help='Range of depth division')
        train.add_argument('--num_epochs', type=int, default=80, help='Total number of training epochs')
        ...
        train.add_argument('--use_synthetic_occlusion', default=True, help='Use synthetic occlusion')
        train.add_argument('--occ_aug_dataset', type=str, default='pascal', help='occ_aug_dataset')
        ...
        # train.add_argument('--flip_factor', type=float, default=0., help='Flip image probability')
        ...
        # train.add_argument('--single_dataname', type=str, default='mpii', help='Name of the single dataset.')
        ...
        train.add_argument('--dist_backend', default='gloo', type=str,
                    help='distributed backend')
        train.add_argument('--dist_url', default='tcp://localhost:10356', type=str,
